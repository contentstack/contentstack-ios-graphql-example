...
```
apollo schema:download --header "access_token:***REMOVED***" --endpoint "https://graphql.contentstack.io/stacks/api_key/explore?access_token=environment-specific_delivery_token&environment=environment_name"
```
