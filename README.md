...
```
apollo schema:download --header "access_token:***REMOVED***" --endpoint "https://graphql.contentstack.io/stacks/api_key/?access_token=environment-specific_delivery_token&environment=environment_name"
```
